                        ...
                        <div class="row">                           
                           <div class="col-md-6">
                              <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Masukan Nama..." value="{{ old('name') }}" required/>
                                    @error('name')
                           ...
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <select class="form-select" name="role" required style="width: 100%">
                                    ...
                                    <option value="kepala" @if(old('role') == 'kepala') selected @endif>kepala</option>
                                 </select>
                                 @error('role')
                                    <div class="invalid-feedback">
                                       {{ $message }}
